...
//LOGIN PAGE
	...
	$sql2 = "SELECT * FROM WALL WHERE rec = '".$_SESSION["id"]."'";
...
<div class='divR'>
	...
	<div class='divL'>
		<?php
			if(strcmp($account["username"], "admin")==0){
				echo "<br/><br/><br/>
					<a href='admin.php' class = 'button'>Remove Users</a>
					<br/><br/><br/><br/>
					<a href='admin2.php' class = 'button'>Remove Events</a>";;
			}
		?>
				<br/><br/><br/><br/>
				<a href="editprofile.php" class = 'button'>Edit Profile</a>
				<br/><br/><br/><br/>
				<a href='finduser.php' class = 'button'>Find User</a>
				<br/><br/><br/><br/>
				<a href="viewevents.php" class = 'button'>View Events</a>
				<br/><br/><br/><br/>
				<a href="createevent.php" class = 'button'>Create Event</a>
				<br/><br/><br/><br/>
